...
% 1) Use a non-hardcoded Matlab root path to prevent problems when the
% Matlab version is changed.
%
% 2) Have a single, central file containing all projects, rather than a
